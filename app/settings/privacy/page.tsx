    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            ...
            toast({
                ...
                description:
                    "Your account deletion has been scheduled. You'll receive a confirmation email.",
            })
        } catch (error) {
        ...
        <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="pt-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            ...
                            personal information. You can also export your data
                            or request that we stop processing it for marketing
                            purposes.
                        </p>
                    </div>
                </CardContent>
                ...
                <CardContent className="space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Help us improve the platform by sharing
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Switch
                                        checked={
                                            privacySettings.analytics_enabled
                                        }
                                ...
                                {isFreeUser && (
                                    <TooltipContent>
                                        <p>
                                            Upgrade to a paid plan to change
                                            this setting.
                                        </p>
                                    </TooltipContent>
                                )}
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Switch
                                        checked={
                                            privacySettings.marketing_emails
                                        }
                                        onCheckedChange={(checked: boolean) =>
                                            handleUpdateSetting(
                                                'marketing_emails',
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Share aggregated, anonymous data with research
                                partners
                            </p>
                        </div>
                        <TooltipProvider>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Track your activity to provide personalized
                                recommendations
                            </p>
                        </div>
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Switch
                                        checked={
                                            privacySettings.activity_tracking
                                        }
                                        onCheckedChange={(checked: boolean) =>
                                            handleUpdateSetting(
                                                'activity_tracking',
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Customize the interface and content based on
                                your preferences
                            </p>
                        </div>
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Switch
                                        checked={
                                            privacySettings.personalization
                                        }
                                        onCheckedChange={(checked: boolean) =>
                                            handleUpdateSetting(
                                                'personalization',
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Help us improve our products and services by
                                sharing anonymous usage data. This data may be
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                ...
                                including projects, preferences, and usage
                                history
                            </p>
                        </div>
                        <TooltipProvider>
                            <Tooltip>
                                ...
                                {isFreeUser && (
                                    <TooltipContent>
                                        <p>
                                            Upgrade to a paid plan to use this
                                            feature.
                                        </p>
                                    </TooltipContent>
                                )}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Questions about privacy or data protection? Get in
                        touch.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                For questions about how we handle your personal
                                data
                            </p>
                            <a
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Read our complete privacy policy for detailed
