...
export default function IntegrationsSettings() {
    ...
    const getIntegrationStatus = useCallback(
        (serviceId: string) => {
            const integration = integrations.find(
                (integration) => integration.service_name === serviceId,
            )
    ...
    const handleConnect = async (serviceId: string) => {
        ...
        try {
            ...
            const success = await upsertUserIntegration(
                session.user.id,
                serviceId,
                {
                    is_connected: true,
    ...
    const handleDisconnect = async (serviceId: string) => {
        ...
        try {
            ...
            const success = await disconnectUserIntegration(
                session.user.id,
                serviceId,
            )
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Manage your connected third-party services and
                        applications.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
                        {availableIntegrations.map((service) => {
                            ...
                            console.log(
                                `Service ${service.id}: connected=${isConnected}, integration=`,
                                integration,
                            )
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            {isConnected &&
                                                ...
                                                typeof integration.connection_data ===
                                                    'object' &&
                                                'connected_at' in
                                                    integration.connection_data && (
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Core features and capabilities enabled in your
                        workspace.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Enable creation and execution of code
                                    artifacts in the sandbox environment
                                </p>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Access to pre-built templates for common
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Cloud-based development environment for
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Manage API keys and access tokens for external
                        integrations.
                    </CardDescription>
                </CardHeader>
                <CardContent>
