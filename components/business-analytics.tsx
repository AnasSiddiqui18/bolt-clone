    ...
    const loadBusinessAnalytics = useCallback(async () => {
        ...
        try {
            const response = await fetch(
                `/api/analytics/business?timeRange=${timeRange}`,
            )
            if (response.ok) {
                ...
                <CardContent className="p-6">
                    <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground mb-4">
                            {error || 'No business analytics available'}
                        </p>
                        <Button
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Revenue analytics and growth insights
                    </p>
                </div>
                ...
                <TabsContent value="overview" className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Daily revenue and user acquisition
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Templates driving the most revenue
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    {product.mostPopularTemplates.map(
                                        (template, index) => (
                                            <div
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    User segments by subscription tier
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <PieChart>
                                        <Pie
                                            data={[
                                                ...
                                                {
                                                    name: 'Enterprise',
                                                    value: users.enterpriseUsers,
                                                    color: '#10b981',
                                                },
                                                {
                                                    name: 'Trial',
                                                    value: users.trialUsers,
                                                    color: '#f59e0b',
                                                },
                                            ]}
                                            cx="50%"
                ...
                <TabsContent value="revenue" className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-3xl font-bold text-green-600">
                                    ${revenue.lifetimeValue}
                                </div>
                                <Progress value={75} className="mt-2" />
                                <p className="text-xs text-muted-foreground mt-2">
                                    75% above industry average
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Revenue, churn, and growth trends
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                ...
                <TabsContent value="product" className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Features by adoption rate and retention impact
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Models by usage and satisfaction
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    {product.mostPopularModels.map(
                                        (model, index) => (
                                            <div
                                                key={model.model}
                                                className="flex items-center justify-between"
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Revenue generated by integrations
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    {product.integrationUsage.map(
                                        (integration, index) => (
                                            <div
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium text-green-600">
                                            {churn.churnPrevention.successRate}%
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-bold text-green-600">
                                            $
                                            {churn.churnPrevention.savedRevenue}
                                        </span>
                                    </div>
                                </div>
                            </CardContent>
