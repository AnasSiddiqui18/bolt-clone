                            ...
                            <TabsContent value="overview" className="space-y-6">
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    <Card className="h-full">
                                        <CardHeader className="pb-3">
                                            ...
                                            <CardDescription className="text-sm">
                                                ...
                                                with our fragment-based system
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="pt-0">
                                            <p className="text-sm text-muted-foreground mb-3">
                                                Start creating applications by
                                    ...
                                    <Card className="h-full">
                                        ...
                                        <CardContent className="pt-0">
                                            <p className="text-sm text-muted-foreground mb-3">
                                                All code runs in secure E2B
                                                sandboxes with 10-minute
                                                execution timeout and full
                                ...
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        <strong>Pro Tip:</strong> Start by
                                        describing what you want to build. Our
                                        AI will automatically select the best
                                        template and generate optimized code for
                                        your use case.
                                    </AlertDescription>
                                </Alert>
                            </TabsContent>
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            ...
                                            executable code units that run in
                                            E2B sandboxes
                                        </CardDescription>
                                    </CardHeader>
                            ...
                            <TabsContent value="models" className="space-y-6">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Multiple AI providers for different
                                    ...
                                    <CardContent>
                                        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                                            ...
                                            <div className="border rounded-lg p-3">
                                                ...
                                                <p className="text-xs text-muted-foreground mb-2">
                                                    Mistral, Fireworks, Together
                                                    AI, xAI, DeepSeek, Ollama
                                                </p>
                                                <Badge
                                                    variant="outline"
                                                    className="text-xs"
                                        ...
                                        <Alert className="mt-4">
                                            ...
                                            <AlertDescription className="text-sm">
                                                Configure API keys in the chat
                                                settings. You can switch between
                                                providers during conversations
                                                to find the best model for your
                                                specific use case.
                                            </AlertDescription>
                                        </Alert>
                                    </CardContent>
                            ...
                            <TabsContent value="sandbox" className="space-y-6">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Secure, isolated execution
                                            environment for AI-generated code
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        <Alert>
                                            <Info className="h-4 w-4" />
                                            <AlertDescription className="text-sm">
                                                Applications run in E2B
                                                sandboxes during development.
                                                Export your code for production
                                                deployment.
                                            </AlertDescription>
                                        </Alert>
                            ...
                            >
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Resolve common problems and optimize
                                            your experience
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        <div className="space-y-3">
                                            <div className="border rounded-lg p-3">
                                                <h4 className="font-semibold text-red-600 mb-2 text-sm">
                                                    Fragment Execution Timeout
                                                </h4>
                                                <p className="text-xs text-muted-foreground mb-2">
                                                    Fragment execution stops
                                                    after 10 minutes
                                                </p>
                                                <div className="space-y-1 text-xs">
                                                    <div>
                                            ...
                                            <div className="border rounded-lg p-3">
                                                <h4 className="font-semibold text-purple-600 mb-2 text-sm">
                                                    AI Model Errors
                                                </h4>
                                                <p className="text-xs text-muted-foreground mb-2">
                                                    API errors or unexpected
                                                    responses
                                                </p>
                                                <div className="space-y-1 text-xs">
                                                    <div>
                                        ...
                                        <Alert className="mt-4">
                                            ...
                                            <AlertDescription className="text-sm">
                                                ...
                                                isolated E2B sandboxes. Avoid
                                                including sensitive data like
